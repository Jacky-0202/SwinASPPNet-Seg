...
IGNORE_INDEX = 255     # Index to ignore in Loss

LEARNING_RATE = 6e-4   # Transformers typically require lower LR than CNNs
SCHEDULER_T0 = 10
SCHEDULER_T_MULT = 2
...
EXPERIMENT_NAME = f"Swin_{model_tag}_Cityscapes"
